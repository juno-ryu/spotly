...
5. `.claude/rules/api-health-check.mdc` — 외부 API 상태 확인
<!-- 6. `claudedocs/prd/소상공인 창업 분석기/prd_20260209.md` — PRD (제품 요구사항, 비즈니스 모델, 스코어링 모델, 로드맵)
7. `claudedocs/prd/소상공인 창업 분석기/scoring_model_v3.md` — 스코어링 모델 v3 (4대 지표 체계, 서울/비서울 분리)
6. `claudedocs/next-phase.md` — 향후 개발 계획, 데이터 소스 연동 로드맵 -->
